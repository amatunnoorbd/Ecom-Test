...
import main_img from '../Image/panjabi/polo_shirt_main.png';
...
const Polo_shirt = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            const fetchedProducts = await getProductByCategories("shirt");
    ...
    return (
        <div className='bg-[#e8e2e2] flex items-center my-12 mx-[4.5%] h-[490px]'>
            {/* Main Image Section */}
            <div className='w-[29%]'>
                <Image
                    src={main_img}
